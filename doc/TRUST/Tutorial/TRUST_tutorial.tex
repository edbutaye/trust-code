...
\title[TRUST Tutorial V1.9.8beta]{TRUST Tutorial V1.9.8beta} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{columns}[c] 
\column{.45\textwidth}
\tableofcontents[sections={1-8},currentsection, currentsubsection]
\column{.5\textwidth} 
\tableofcontents[sections={9-16},currentsection, currentsubsection]
\end{columns}
\end{small}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{{\bf{Flow around an obstacle (2D, VDF, TRUST)}}} \label{exo1}
...
\section{{\bf{Heat transfer (2D, VDF/VEF, TRUST)}}} \label{docond_pb_couple}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Dilatable flows (2D, TRUST)}}}
...
\section{{\bf{Periodic channel flow (3D, TRUST)}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Constituents \& turbulent flow (TrioCFD)}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Turbulent flow in a curved pipe (3D, TrioCFD)}}} \label{prm_para}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Turbulent flow over a backward-facing step (3D, TrioCFD)}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Tank filling (2D, single-phase flow, TRUST)}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
...
\section{{\bf{Tank filling (3D, two-phase flow, TrioCFD)}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{small}
\begin{columns}[c] 
